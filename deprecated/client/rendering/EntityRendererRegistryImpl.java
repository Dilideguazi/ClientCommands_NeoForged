...
public final class EntityRendererRegistryImpl {
	private static final HashMap<EntityType<?>, EntityRendererProvider<?>> map = new HashMap<>();
//	private static BiConsumer<EntityType<?>, EntityRendererProvider<?>> handler = (type, function) -> map.put(type, function);
	private static BiConsumer<EntityType<?>, EntityRendererProvider<?>> handler = map::put;
