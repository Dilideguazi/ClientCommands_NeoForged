...
import net.fabricmc.fabric.mixin.network.accessor.CustomPayloadC2SPacketAccessor;
import net.fabricmc.fabric.mixin.network.accessor.ServerPlayNetworkHandlerAccessor;
...
public final class ServerPlayNetworkAddon extends AbstractChanneledNetworkAddon<ServerPlayNetworking.PlayChannelHandler> {
	...
	public boolean handle(ServerboundCustomPayloadPacket packet) {
		...
		return this.handle(access.identifier(), access.data());
	}
