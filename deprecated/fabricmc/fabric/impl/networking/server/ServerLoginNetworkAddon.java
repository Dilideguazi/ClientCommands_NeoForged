...
import net.fabricmc.fabric.mixin.network.accessor.LoginQueryResponseC2SPacketAccessor;
...
//		return this.channels.isEmpty() && this.waits.isEmpty();
	...
	public boolean handle(ServerboundCustomQueryPacket packet) {
		...
		return handle(access.transactionId(), access.data());
	}
...
//		ClientboundCustomQueryPacket ret = new ClientboundCustomQueryPacket(queryId, channelName, buf);
        return new ClientboundCustomQueryPacket(queryId, channelName, buf);
	}
