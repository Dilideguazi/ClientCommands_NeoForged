...
public final class ServerPlayNetworking {
	 ...
	 * must be modified in the server thread by calling {@link BlockableEventLoop#execute(Runnable)}.
	 *
	...
	public interface PlayChannelHandler {
		 ...
		 * Modification to the game should be {@linkplain BlockableEventLoop#submit(Runnable) scheduled} using the provided Minecraft server instance.
		 *
