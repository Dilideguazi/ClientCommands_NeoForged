...
public final class ServerLoginNetworking {
	...
	public interface LoginQueryResponseHandler {
		 ...
		 * Modification to the game should be {@linkplain BlockableEventLoop#submit(Runnable) scheduled} using the provided Minecraft client instance.
		 *
	...
	public interface LoginSynchronizer {
		 ...
		 * });
		 * }</pre>
		 * Usually it is enough to pass the return value for {@link BlockableEventLoop#submit(Runnable)} for {@code future}.</p>
		 *
