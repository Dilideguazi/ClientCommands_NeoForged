...
import net.earthcomputer.clientcommands.Clientcommands_reforged;
...
public final class ArgumentTypeRegistry {
	public static final DeferredRegister<ArgumentTypeInfo<?, ?>> ARGUMENT_TYPE_INFOS =
			DeferredRegister.create(ForgeRegistries.COMMAND_ARGUMENT_TYPES, Clientcommands_reforged.MOD_ID);
