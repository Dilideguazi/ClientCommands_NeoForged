...
public class WaypointColorArgument implements ArgumentType<WaypointColor> {
    ...
    // Neo Edit: Needs ArgumentTypeInfo
    public static final ArgumentTypeInfo<WaypointColorArgument, ?> INFO =
            SingletonArgumentInfo.contextFree(WaypointColorArgument::waypointColor);
