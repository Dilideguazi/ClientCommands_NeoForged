...
public class CColorArgumentType implements ArgumentType<ChatFormatting> {

	private static final Collection<String> EXAMPLES = Arrays.asList("red", "green");
	public static final DynamicCommandExceptionType INVALID_COLOR_EXCEPTION = new DynamicCommandExceptionType(color -> Component.translatable("argument.color.invalid", color));

	public static CColorArgumentType color() {
		return new CColorArgumentType();
	}

	public static ChatFormatting getCColor(final CommandContext<FabricClientCommandSource> context, final String name) {
