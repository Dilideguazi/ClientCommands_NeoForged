...
public class CEntityArgumentType implements ArgumentType<CEntitySelector> {
	...
	public static Collection<AbstractClientPlayer> getCOptionalPlayers(final CommandContext<FabricClientCommandSource> context, final String name) throws CommandSyntaxException {
	...
	public static AbstractClientPlayer getCPlayer(final CommandContext<FabricClientCommandSource> context, final String name) throws CommandSyntaxException {
	...
	public static Collection<AbstractClientPlayer> getCPlayers(final CommandContext<FabricClientCommandSource> context, final String name) throws CommandSyntaxException {
