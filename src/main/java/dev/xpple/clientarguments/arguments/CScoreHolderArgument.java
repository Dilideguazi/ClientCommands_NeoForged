...
public class CScoreHolderArgument implements ArgumentType<CScoreHolderArgument.Result> {
	...
	public <S> Result parse(final StringReader stringReader, final S source) throws CommandSyntaxException {
		return this.parse(stringReader, CEntitySelectorParser.allowSelectors(source));
	}

	private Result parse(final StringReader stringReader, final boolean selectorsAllowed) throws CommandSyntaxException {
