...
public class CResourceSelectorArgument<T> implements ArgumentType<Collection<Holder.Reference<T>>> {
    ...
    public static class Info<T> implements ArgumentTypeInfo<CResourceSelectorArgument<T>, Info<T>.Template> {
        ...
        public Template unpack(CResourceSelectorArgument<T> resourceSelectorArgument) {
