...
public class CEntityAnchorArgumentType implements ArgumentType<CEntityAnchorArgumentType.EntityAnchor> {
	...
	private static final DynamicCommandExceptionType INVALID_ANCHOR_EXCEPTION = new DynamicCommandExceptionType(name -> Component.translatable("argument.anchor.invalid", name));
	...
	public enum EntityAnchor {
		...
		EntityAnchor(String id, BiFunction<Vec3, Entity, Vec3> offset) {
			this.id = id;
			this.offset = offset;
		}
