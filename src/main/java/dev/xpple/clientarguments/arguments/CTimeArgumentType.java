...
public class CTimeArgumentType implements ArgumentType<Integer> {
    ...
    private static final Dynamic2CommandExceptionType TICK_COUNT_TOO_LOW_EXCEPTION = new Dynamic2CommandExceptionType((value, minimum) -> Component.translatable("argument.time.tick_count_too_low", minimum, value));
