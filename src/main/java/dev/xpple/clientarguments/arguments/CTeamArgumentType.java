...
public class CTeamArgumentType implements ArgumentType<String> {
	...
	private static final DynamicCommandExceptionType UNKNOWN_TEAM_EXCEPTION = new DynamicCommandExceptionType(name -> Component.translatable("team.notFound", name));

	public static CTeamArgumentType team() {
		return new CTeamArgumentType();
	}

	public static PlayerTeam getCTeam(final CommandContext<FabricClientCommandSource> context, final String name) throws CommandSyntaxException {
