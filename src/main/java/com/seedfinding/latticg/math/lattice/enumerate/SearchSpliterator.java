...
import com.seedfinding.latticg.math.lattice.enumerate.SearchNode;
import java.util.Deque;
import java.util.LinkedList;
import java.util.Spliterator;
import java.util.function.Consumer;

class SearchSpliterator
implements Spliterator<BigVector> {
    ...
    public Spliterator<BigVector> trySplit() {
        ...
        LinkedList<SearchNode> split = new LinkedList<SearchNode>();
