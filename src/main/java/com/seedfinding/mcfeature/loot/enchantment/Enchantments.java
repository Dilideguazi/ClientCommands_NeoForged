...
public class Enchantments {
	...
	public final static HashSet<String> ARMOR_HEAD = new HashSet<>() {{
	...
	public final static HashSet<String> ARMOR_CHEST = new HashSet<>() {{
		for (String type : ARMOR_TYPES) {
	...
	public final static HashSet<String> ARMOR_LEGGINGS = new HashSet<>() {{
		for (String type : ARMOR_TYPES) {
			add(type + "_LEGGINGS");
		}
		addAll(BOOKS);
	}};
	public final static HashSet<String> ARMOR_FEET = new HashSet<>() {{
		for (String type : ARMOR_TYPES) {
			add(type + "_BOOTS");
		}
		addAll(BOOKS);
	}};
	public final static HashSet<String> ARMOR = new HashSet<>() {{
		addAll(ARMOR_HEAD);
		addAll(ARMOR_CHEST);
	...
	public final static HashSet<String> SWORDS = new HashSet<>() {{
		for (String type : TOOL_TYPES) {
			add(type + "_SWORD");
		}
	}};
	public final static HashSet<String> AXES = new HashSet<>() {{
		for (String type : TOOL_TYPES) {
			add(type + "_AXE");
		}
	}};
	public final static HashSet<String> HOES = new HashSet<>() {{
		for (String type : TOOL_TYPES) {
			add(type + "_HOE");
		}
	}};
	public final static HashSet<String> PICKAXES =new HashSet<>() {{
		for (String type : TOOL_TYPES) {
			add(type + "_PICKAXE");
		}
	}};
	public final static HashSet<String> SHOVELS = new HashSet<>() {{
		for (String type : TOOL_TYPES) {
			add(type + "_SHOVEL");
		}
	}};
	public final static HashSet<String> BOW = new HashSet<>() {{
		add("BOW");
		addAll(BOOKS);
	}};
	public final static HashSet<String> CROSSBOW =  new HashSet<>() {{
		add("CROSSBOW");
		addAll(BOOKS);
	}};
	public final static HashSet<String> FISHING_ROD =  new HashSet<>() {{
		add("FISHING_ROD");
		addAll(BOOKS);
	}};
	public final static HashSet<String> TRIDENT =  new HashSet<>() {{
		add("TRIDENT");
		addAll(BOOKS);
	}};
	public final static HashSet<String> BREAKABLE = new HashSet<>() {{
		addAll(CROSSBOW);
		addAll(BOW);
		addAll(TRIDENT);
		addAll(FISHING_ROD);
	...
	public final static HashSet<String> DIGGER = new HashSet<>() {{
		addAll(HOES);
		addAll(PICKAXES);
		addAll(AXES);
		addAll(SHOVELS);
	...
	public final static HashSet<String> WEAPON = new HashSet<>() {{
		addAll(SWORDS);
		addAll(BOOKS);
	}};
	public final static HashSet<String> DAMAGE = new HashSet<>() {{
		addAll(SWORDS);
		addAll(AXES);
		addAll(BOOKS);
	}};
	public final static HashSet<String> THORNS = new HashSet<>() {{
		addAll(ARMOR_CHEST);
		remove("ELYTRA");
	}};
	public final static HashSet<String> VANISHABLE = new HashSet<>() {{
		addAll(BREAKABLE);
	}};
