 ...
 */
package com.cc_seedfinding.latticg.math.lattice.enumeration;
...
import com.cc_seedfinding.latticg.math.lattice.enumerate.EnumerateRt;
import com.cc_seedfinding.latticg.math.optimize.Optimize;
...
public class Enumerate {
    ...
    public static Stream<BigVector> enumerate(BigMatrix basis, BigVector lower, BigVector upper, BigVector origin) {
        ...
        return Enumerate.enumerate(basis, origin, builder.build());
    }
}
