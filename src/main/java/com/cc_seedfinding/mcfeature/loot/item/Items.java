...
public class Items {
	...
	// TODO make version dependent like blocks
	...
	public static final Item PALE_OAK_PLANKS = register(new Item("pale_oak_planks"));
	...
	public static final Item PALE_OAK_SAPLING = register(new Item("pale_oak_sapling"));
	...
	public static final Item PALE_OAK_LOG = register(new Item("pale_oak_log"));
	...
	public static final Item STRIPPED_PALE_OAK_LOG = register(new Item("stripped_pale_oak_log"));
	...
	public static final Item STRIPPED_PALE_OAK_WOOD = register(new Item("stripped_pale_oak_wood"));
	...
	public static final Item PALE_OAK_WOOD = register(new Item("pale_oak_wood"));
	...
	public static final Item PALE_OAK_LEAVES = register(new Item("pale_oak_leaves"));
	...
	public static final Item BUSH = register(new Item("bush"));
	...
	public static final Item FIREFLY_BUSH = register(new Item("firefly_bush"));
	public static final Item DRY_SHORT_GRASS = register(new Item("short_dry_grass"));
	public static final Item DRY_TALL_GRASS = register(new Item("tall_dry_grass"));
	...
	public static final Item OPEN_EYEBLOSSOM = register(new Item("open_eyeblossom"));
	public static final Item CLOSED_EYEBLOSSOM = register(new Item("closed_eyeblossom"));
	...
	public static final Item WILDFLOWERS = register(new Item("wildflowers"));
	public static final Item LEAF_LITTER = register(new Item("leaf_litter"));
	...
	public static final Item PALE_MOSS_CARPET = register(new Item("pale_moss_carpet"));
	public static final Item PALE_HANGING_MOSS = register(new Item("pale_hanging_moss"));
	public static final Item PALE_MOSS_BLOCK = register(new Item("pale_moss_block"));
	...
	public static final Item PALE_OAK_SLAB = register(new Item("pale_oak_slab"));
	...
	public static final Item CUT_STANDSTONE_SLAB = register(new Item("cut_sandstone_slab"));
	...
	public static final Item CREAKING_HEART = register(new Item("creaking_heart"));
	...
	public static final Item CACTUS_FLOWER = register(new Item("cactus_flower"));
	...
	public static final Item PALE_OAK_FENCE = register(new Item("pale_oak_fence"));
	...
	public static final Item RESIN_CLUMP = register(new Item("resin_clump"));
	public static final Item RESIN_BLOCK = register(new Item("resin_block"));
	public static final Item RESIN_BRICKS = register(new Item("resin_bricks"));
	public static final Item RESIN_BRICK_STAIRS = register(new Item("resin_brick_stairs"));
	public static final Item RESIN_BRICK_SLAB = register(new Item("resin_brick_slab"));
	public static final Item RESIN_BRICK_WALL = register(new Item("resin_brick_wall"));
	public static final Item CHISELED_RESIN_BRICKS = register(new Item("chiseled_resin_bricks"));
	...
	public static final Item PALE_OAK_STAIRS = register(new Item("pale_oak_stairs"));
	...
	public static final Item DRIED_GHAST = register(new Item("dried_ghast"));
	...
	public static final Item PALE_OAK_BUTTON = register(new Item("pale_oak_button"));
	...
	public static final Item PALE_OAK_PRESSURE_PLATE = register(new Item("pale_oak_pressure_plate"));
	...
	public static final Item PALE_OAK_DOOR = register(new Item("pale_oak_door"));
	...
	public static final Item PALE_OAK_TRAPDOOR = register(new Item("pale_oak_trapdoor"));
	...
	public static final Item PALE_OAK_FENCE_GATE = register(new Item("pale_oak_fence_gate"));
	...
	public static final Item WHITE_HARNESS = register(new Item("white_harness"));
	public static final Item ORANGE_HARNESS = register(new Item("orange_harness"));
	public static final Item MAGENTA_HARNESS = register(new Item("magenta_harness"));
	public static final Item LIGHT_BLUE_HARNESS = register(new Item("light_blue_harness"));
	public static final Item YELLOW_HARNESS = register(new Item("yellow_harness"));
	public static final Item LIME_HARNESS = register(new Item("lime_harness"));
	public static final Item PINK_HARNESS = register(new Item("pink_harness"));
	public static final Item GRAY_HARNESS = register(new Item("gray_harness"));
	public static final Item LIGHT_GRAY_HARNESS = register(new Item("light_gray_harness"));
	public static final Item CYAN_HARNESS = register(new Item("cyan_harness"));
	public static final Item PURPLE_HARNESS = register(new Item("purple_harness"));
	public static final Item BLUE_HARNESS = register(new Item("blue_harness"));
	public static final Item BROWN_HARNESS = register(new Item("brown_harness"));
	public static final Item GREEN_HARNESS = register(new Item("green_harness"));
	public static final Item RED_HARNESS = register(new Item("red_harness"));
	public static final Item BLACK_HARNESS = register(new Item("black_harness"));
	...
	public static final Item OAK_CHEST_BOAT = register(new Item("oak_chest_boat"));
	public static final Item SPRUCE_BOAT = register(new Item("spruce_boat"));
	public static final Item SPRUCE_CHEST_BOAT = register(new Item("spruce_chest_boat"));
	public static final Item BIRCH_BOAT = register(new Item("birch_boat"));
	public static final Item BIRCH_CHEST_BOAT = register(new Item("birch_chest_boat"));
	public static final Item JUNGLE_BOAT = register(new Item("jungle_boat"));
	public static final Item JUNGLE_CHEST_BOAT = register(new Item("jungle_chest_boat"));
	public static final Item ACACIA_BOAT = register(new Item("acacia_boat"));
	public static final Item ACACIA_CHEST_BOAT = register(new Item("acacia_chest_boat"));
	public static final Item CHERRY_BOAT = register(new Item("cherry_boat"));
	public static final Item CHERRY_CHEST_BOAT = register(new Item("cherry_chest_boat"));
	public static final Item DARK_OAK_BOAT = register(new Item("dark_oak_boat"));
	public static final Item DARK_OAK_CHEST_BOAT = register(new Item("dark_oak_chest_boat"));
	public static final Item PALE_OAK_BOAT = register(new Item("pale_oak_boat"));
	public static final Item PALE_OAK_CHEST_BOAT = register(new Item("pale_oak_chest_boat"));
	public static final Item MANGROVE_BOAT = register(new Item("mangrove_boat"));
	public static final Item MANGROVE_CHEST_BOAT = register(new Item("mangrove_chest_boat"));
	public static final Item BAMBOO_RAFT = register(new Item("bamboo_raft"));
	public static final Item BAMBOO_CHEST_RAFT = register(new Item("bamboo_chest_raft"));
	...
	public static final Item TEST_BLOCK = register(new Item("test_block"));
	public static final Item TEST_INSTANCE_BLOCK = register(new Item("test_instance_block"));
	public static final Item TURTLE_HELMET = register(new Item("turtle_helmet"));
	public static final Item TURTLE_SCUTE = register(new Item("turtle_scute"));
	public static final Item ARMADILLO_SCUTE = register(new Item("armadillo_scute"));
	public static final Item WOLF_ARMOR = register(new Item("wolf_armor"));
	...
	public static final Item PALE_OAK_SIGN = register(new Item("pale_oak_sign"));
	...
	public static final Item PALE_OAK_HANGING_SIGN = register(new Item("pale_oak_hanging_sign"));
	...
	public static final Item TADPOLE_BUCKET = register(new Item("tadpole_bucket"));
	...
	public static final Item BLUE_EGG = register(new Item("blue_egg"));
	public static final Item BROWN_EGG = register(new Item("brown_egg"));
	...
	public static final Item WHITE_BUNDLE = register(new Item("white_bundle"));
	public static final Item ORANGE_BUNDLE = register(new Item("orange_bundle"));
	public static final Item MAGENTA_BUNDLE = register(new Item("magenta_bundle"));
	public static final Item LIGHT_BLUE_BUNDLE = register(new Item("light_blue_bundle"));
	public static final Item YELLOW_BUNDLE = register(new Item("yellow_bundle"));
	public static final Item LIME_BUNDLE = register(new Item("lime_bundle"));
	public static final Item PINK_BUNDLE = register(new Item("pink_bundle"));
	public static final Item GRAY_BUNDLE = register(new Item("gray_bundle"));
	public static final Item LIGHT_GRAY_BUNDLE = register(new Item("light_gray_bundle"));
	public static final Item CYAN_BUNDLE = register(new Item("cyan_bundle"));
	public static final Item PURPLE_BUNDLE = register(new Item("purple_bundle"));
	public static final Item BLUE_BUNDLE = register(new Item("blue_bundle"));
	public static final Item BROWN_BUNDLE = register(new Item("brown_bundle"));
	public static final Item GREEN_BUNDLE = register(new Item("green_bundle"));
	public static final Item RED_BUNDLE = register(new Item("red_bundle"));
	public static final Item BLACK_BUNDLE = register(new Item("black_bundle"));
	...
	public static final Item ARMADILLO_SPAWN_EGG = register(new Item("armadillo_spawn_egg"));
	...
	public static final Item BOGGED_SPAWN_EGG = register(new Item("bogged_spawn_egg"));
	public static final Item BREEZE_SPAWN_EGG = register(new Item("breeze_spawn_egg"));
	...
	public static final Item FROG_SPAWN_EGG = register(new Item("frog_spawn_egg"));
	public static final Item GHAST_SPAWN_EGG = register(new Item("ghast_spawn_egg"));
	public static final Item HAPPY_GHAST_SPAWN_EGG = register(new Item("happy_ghast_spawn_egg"));
	...
	public static final Item CREAKING_SPAWN_EGG = register(new Item("creaking_spawn_egg"));
	...
	public static final Item WIND_CHARGE = register(new Item("wind_charge"));
	...
	public static final Item BREEZE_ROD = register(new Item("breeze_rod"));
	public static final Item MACE = register(new Item("mace"));
	...
	public static final Item RESIN_BRICK = register(new Item("resin_brick"));
	...
	public static final Item MUSIC_DISC_CREATOR = register(new Item("music_disc_creator"));
	public static final Item MUSIC_DISC_CREATOR_MUSIC_BOX = register(new Item("music_disc_creator_music_box"));
	public static final Item MUSIC_DISC_FAR = register(new Item("music_disc_far"));
	public static final Item MUSIC_DISC_LAVA_CHICKEN = register(new Item("music_disc_lava_chicken"));
	...
	public static final Item MUSIC_DISC_PRECIPICE = register(new Item("music_disc_precipice"));
	public static final Item MUSIC_DISC_TEARS = register(new Item("music_disc_tears"));
	public static final Item DISC_FRAGMENT_5 = register(new Item("disc_fragment_5"));
	...
	public static final Item FLOW_BANNER_PATTERN = register(new Item("flow_banner_pattern"));
	public static final Item GUSTER_BANNER_PATTERN = register(new Item("guster_banner_pattern"));
	public static final Item FIELD_MASONED_BANNER_PATTERN = register(new Item("field_masoned_banner_pattern"));
	public static final Item BORDURE_INDENTED_BANNER_PATTERN = register(new Item("bordure_indented_banner_pattern"));
	...
	public static final Item NETHERITE_UPGRADE_SMITHING_TEMPLATE = register(new Item("netherite_upgrade_smithing_template"));
	public static final Item SENTRY_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("sentry_armor_trim_smithing_template"));
	public static final Item DUNE_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("dune_armor_trim_smithing_template"));
	public static final Item COAST_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("coast_armor_trim_smithing_template"));
	public static final Item WILD_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("wild_armor_trim_smithing_template"));
	public static final Item WARD_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("ward_armor_trim_smithing_template"));
	public static final Item EYE_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("eye_armor_trim_smithing_template"));
	public static final Item VEX_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("vex_armor_trim_smithing_template"));
	public static final Item TIDE_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("tide_armor_trim_smithing_template"));
	public static final Item SNOUT_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("snout_armor_trim_smithing_template"));
	public static final Item RIB_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("rib_armor_trim_smithing_template"));
	public static final Item SPIRE_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("spire_armor_trim_smithing_template"));
	public static final Item WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("wayfinder_armor_trim_smithing_template"));
	public static final Item SHAPER_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("shaper_armor_trim_smithing_template"));
	public static final Item SILENCE_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("silence_armor_trim_smithing_template"));
	public static final Item RAISER_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("raiser_armor_trim_smithing_template"));
	public static final Item HOST_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("host_armor_trim_smithing_template"));
	public static final Item FLOW_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("flow_armor_trim_smithing_template"));
	public static final Item BOLT_ARMOR_TRIM_SMITHING_TEMPLATE = register(new Item("bolt_armor_trim_smithing_template"));
	...
	public static final Item FLOW_POTTERY_SHERD = register(new Item("flow_pottery_sherd"));
	public static final Item FRIEND_POTTERY_SHERD = register(new Item("friend_pottery_sherd"));
	public static final Item GUSTER_POTTERY_SHERD = register(new Item("guster_pottery_sherd"));
	...
	public static final Item SCRAPE_POTTERY_SHERD = register(new Item("scrape_pottery_sherd"));
	...
	public static final Item TRIAL_KEY = register(new Item("trial_key"));
	public static final Item OMINOUS_TRIAL_KEY = register(new Item("ominous_trial_key"));
	public static final Item VAULT = register(new Item("vault"));
	public static final Item OMINOUS_BOTTLE = register(new Item("ominous_bottle"));
