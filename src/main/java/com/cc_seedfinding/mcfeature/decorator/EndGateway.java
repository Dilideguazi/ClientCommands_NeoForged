package com.cc_seedfinding.mcfeature.decorator;
...
public class EndGateway extends BiomelessDecorator<EndGateway.Config, EndGateway.Data> {
	...
	public static final VersionMap<Config> CONFIGS = new VersionMap<Config>()
		.add(MCVersion.v1_13, new Config(0, 3, 700))
		.add(MCVersion.v1_16, new Config(0, 4, 700))
		.add(MCVersion.v1_17, new Config(13, 4, 700));
	...
	public Data getData(long structureSeed, int chunkX, int chunkZ, ChunkRand rand) {
		...
		return new Data(this, blockX, blockZ, rand.nextInt(7) + 3);
	}

	public Data at(int blockX, int blockZ, int height) {
		return new Data(this, blockX, blockZ, height);
	}
