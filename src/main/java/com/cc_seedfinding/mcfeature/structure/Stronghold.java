...
import com.cc_seedfinding.mccore.util.block.BlockDirection;
...
import com.cc_seedfinding.mcfeature.structure.generator.piece.StructurePiece;
import com.cc_seedfinding.mcfeature.structure.generator.piece.stronghold.Start;
import com.cc_seedfinding.mcfeature.structure.generator.structure.StrongholdGenerator;
...
public class Stronghold extends Structure<Stronghold.Config, Stronghold.Data> {
	...
	public static final VersionMap<Config> CONFIGS = new VersionMap<Config>()
		.add(MCVersion.v1_0, new Config(32, 3, 3))
		.add(MCVersion.v1_9, new Config(32, 3, 128));
