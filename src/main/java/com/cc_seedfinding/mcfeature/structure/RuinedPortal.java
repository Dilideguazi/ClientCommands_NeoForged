...
import com.cc_seedfinding.mcfeature.structure.generator.structure.RuinedPortalGenerator;
...
public class RuinedPortal extends UniformStructure<RuinedPortal> implements ILoot {
	...
	public static final VersionMap<Config> OVERWORLD_CONFIGS = new VersionMap<Config>()
		.add(MCVersion.v1_16, new Config(40, 15, 34222645));

	public static final VersionMap<Config> NETHER_CONFIGS = new VersionMap<Config>()
		.add(MCVersion.v1_16, new Config(25, 10, 34222645));
