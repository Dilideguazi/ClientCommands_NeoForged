...
import com.cc_seedfinding.mccore.util.math.DistanceMetric;
...
public class PillagerOutpost extends OldStructure<PillagerOutpost> {
	...
	public static final VersionMap<Config> CONFIGS = new VersionMap<Config>()
		.add(MCVersion.v1_14, new Config(165745296));
	...
	public boolean hasNearbyVillage(long structureSeed, int chunkX, int chunkZ, ChunkRand rand) {
		...
		Data<?> nw = this.village.at(chunkX - 10, chunkZ - 10);
		Data<?> se = this.village.at(chunkX + 10, chunkZ + 10);
