...
import static net.earthcomputer.clientcommands.command.arguments.WithStringArgument.getWithString;
import static net.earthcomputer.clientcommands.command.arguments.WithStringArgument.withString;
    ...
    public static void register(CommandDispatcher<FabricClientCommandSource> dispatcher, CommandBuildContext context) {
        var cfindblock = dispatcher.register(literal("cfindblock")
            .then(argument("block", withString(blockPredicate(context)))
                .executes(ctx -> {
                    var blockWithString = getWithString(ctx, "block", ParseResult.class);
