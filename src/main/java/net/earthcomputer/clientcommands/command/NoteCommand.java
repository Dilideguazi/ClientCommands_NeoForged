...
import static net.earthcomputer.clientcommands.command.arguments.FormattedComponentArgument.formattedComponent;
import static net.earthcomputer.clientcommands.command.arguments.FormattedComponentArgument.getFormattedComponent;
