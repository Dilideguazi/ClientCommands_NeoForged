...
import static net.earthcomputer.clientcommands.command.arguments.EntityUUIDArgument.entityUuid;
import static net.earthcomputer.clientcommands.command.arguments.EntityUUIDArgument.getEntityUuid;
