...
class SnakeGameScreen extends Screen {
    ...
    private static final ResourceLocation GRID_TEXTURE = ResourceLocation.tryParse("clientcommands:textures/snake_grid.png");
    ...
    public void renderBackground(@NotNull GuiGraphics context) {
        ...
        context.drawString(client.font, score, this.width / 2, startY - 10, 0xff_ffffff);

        assert GRID_TEXTURE != null;
