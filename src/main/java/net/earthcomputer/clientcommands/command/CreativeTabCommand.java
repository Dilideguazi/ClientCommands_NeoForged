...
public class CreativeTabCommand {
    ...
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS = DeferredRegister
            .create(BuiltInRegistries.CREATIVE_MODE_TAB, Client_commands_neoforged.MOD_ID);
    ...
    private static void loadFile() throws IOException {
        ...
        // Neo Edit: in the constructor of the main class (Client_commands_neoforged), the game is not initialized completely. So if you use Minecraft, the game will crash.
...
//                    .build());
            ...
            CREATIVE_MODE_TABS.register(key, () -> CreativeModeTab.builder()
                    .title(Component.literal(key))
                    .icon(() -> singleItemFromNbt(builtinLookupProvider, icon))
                    .displayItems((displayContext, entries) -> {
                        Set<ItemStack> existingStacks = ItemStackLinkedSet.createTypeAndComponentsSet();
