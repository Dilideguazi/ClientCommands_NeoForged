...
public class RenderQueue {
    ...
    static {
        ...
        WorldRenderEvents.AFTER_ENTITIES.register(context -> {
            ...
            RenderQueue.render(Layer.ON_TOP, Objects.requireNonNull(context.consumers()).getBuffer(RenderQueue.NO_DEPTH_LAYER), context.matrixStack(), context.tickCounter().getRealtimeDeltaTicks());
