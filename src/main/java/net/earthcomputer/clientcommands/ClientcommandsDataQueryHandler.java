...
import net.earthcomputer.clientcommands.mixin.DebugQueryHandlerAccessor;
...
//        int transactionId = ++networkHandler.getDebugQueryHandler().transactionId;
        int transactionId = ((DebugQueryHandlerAccessor) networkHandler.getDebugQueryHandler()).getTransactionId() + 1;
        ((DebugQueryHandlerAccessor) networkHandler.getDebugQueryHandler()).setTransactionId(transactionId);
