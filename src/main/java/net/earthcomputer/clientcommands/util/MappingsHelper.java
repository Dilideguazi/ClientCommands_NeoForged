...
public final class MappingsHelper {
    ...
    private static final boolean IS_DEV_ENV = !FMLLoader.isProduction();
    ...
    private static final MemoryMappingTree officialIntermediaryNamed = Util.make(() -> {
        ...
        try (InputStream stream = Client_commands_neoforged.class.getClassLoader().getResourceAsStream("mappings/mappings.tiny")) {
            if (stream == null) {
