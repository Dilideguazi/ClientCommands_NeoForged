...
import com.cc_seedfinding.mcfeature.loot.effect.Effect;
import com.cc_seedfinding.mcfeature.loot.effect.Effects;
...
public class SeedfindingUtil {
    ...
    public static com.cc_seedfinding.mcbiome.biome.@Nullable Biome toSeedfindingBiome(Level level, Holder<Biome> biome) {
    ...
    public static ItemStack fromSeedfindingItem(com.cc_seedfinding.mcfeature.loot.item.Item item, RegistryAccess registryAccess) {
        return fromSeedfindingItem(new com.cc_seedfinding.mcfeature.loot.item.ItemStack(item), registryAccess);
    }

    public static ItemStack fromSeedfindingItem(com.cc_seedfinding.mcfeature.loot.item.ItemStack stack, RegistryAccess registryAccess) {
