...
public abstract sealed class MultiVersionCompat {
    ...
    public static final MultiVersionCompat INSTANCE = Util.make(() -> {
        try {
            // Neo Edit: ViaNeoForgePlus
//            if (ModList.get().isLoaded("viafabric")) {
//                return new ViaFabric();
//            } else if (ModList.get().isLoaded("viafabricplus")) {
//                return new ViaFabricPlus();
            if (ModList.get().isLoaded("vianeoforgeplus")) {
                return new ViaNeoForgePlus();
            } else {
                return new None();
            }
...
//    }
    ...
    private static final class ViaNeoForgePlus extends AbstractViaVersion {
        ...
        private ViaNeoForgePlus() throws ReflectiveOperationException {
