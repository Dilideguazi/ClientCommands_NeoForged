...
public class CCNetworkHandler implements CCPacketListener {
    ...
    public void sendPacket(C2CPacket packet, PlayerInfo recipient) throws CommandSyntaxException {
        ...
        buf.writeInt(id);
        packet.write(buf);
        byte[] compressed = ConversionHelper.Gzip.compress(buf.accessByteBufWithCorrectSize());
        ...
        Objects.requireNonNull(Minecraft.getInstance().getConnection()).sendCommand(commandString);
