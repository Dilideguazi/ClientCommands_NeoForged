...
//                data[dataPtr / 8 + 2] |= codepoint >> 8;
                data[dataPtr / 8] = (byte) (data[dataPtr / 8] | codepoint << (dataPtr % 8));
                codepoint >>= 8 - (dataPtr % 8);
                data[dataPtr / 8 + 1] = (byte) (data[dataPtr / 8 + 1] | codepoint);
                data[dataPtr / 8 + 2] = (byte) (data[dataPtr / 8 + 2] | codepoint >> 8);
                dataPtr += 20;
            }
