 ...
 *     Related events are found at {@link ServerLoginConnectionEvents},
 *     and related methods are found at {@link ServerLoginNetworking}.
 *     </dd>
 *     <dt>CONFIGURATION</dt>
 ...
 *     Related events are found at {@link ClientboundConfigurationChannelEvents}
 *     {@link ServerConfigurationConnectionEvents}, and related methods are found at
 *     {@link ServerConfigurationNetworking}.
 *     </dd>
 *     <dt>PLAY</dt>
 ...
 *     {@link ClientboundPlayChannelEvents}
 *     and {@link ServerPlayConnectionEvents}, and related methods are found at
 *     {@link ServerPlayNetworking}.</dd>
 * </dl>
 *
 * <p>In addition, this API includes helpers for {@linkplain
 * PayloadTypeRegistry registering custom packet payloads} and {@linkplain
 * PlayerLookup player lookups}.
 */
