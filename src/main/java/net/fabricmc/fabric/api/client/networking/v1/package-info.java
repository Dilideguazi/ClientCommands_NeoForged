 ...
 *     Related events are found at {@link ClientLoginConnectionEvents},
 *     and related methods are found at {@link ClientLoginNetworking}.
 *     </dd>
 *     <dt>CONFIGURATION</dt>
 ...
 *     Related events are found at {@link ServerboundConfigurationChannelEvents}
 *     and {@link ClientConfigurationConnectionEvents}, and related methods are found at
 *     {@link ClientConfigurationNetworking}.
 *     </dd>
 *     <dt>PLAY</dt>
 ...
 *     {@link ServerboundPlayChannelEvents}
 *     and {@link ClientPlayConnectionEvents}, and related methods are found at
 *     {@link ClientPlayNetworking}.</dd>
 * </dl>
 */
